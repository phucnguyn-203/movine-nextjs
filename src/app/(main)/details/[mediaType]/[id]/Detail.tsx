...
export default function Detail({ details, cast, mediaType }: Props) {
    ...
    return (
        <main className="min-h-screen bg-black">
            ...
            <div className="relative min-h-[calc(100vh-4rem)] w-full">
                ...
                >
                    <Image
                        src={`${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}/original${details.backdrop_path}`}
                        alt={title || ""}
                        fill
                                ...
                                >
                                    <div className="relative aspect-[2/3] rounded-lg overflow-hidden mb-2 sm:mb-3">
                                        <Image
                                            src={
                                                actor.profile_path
                                                    ? `${process.env.NEXT_PUBLIC_IMAGE_BASE_URL}/w500${actor.profile_path}`
                                                    : "/placeholder.png"
                                            }
                                            alt={actor.name}
                                            fill
